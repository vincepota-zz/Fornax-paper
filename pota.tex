...
\ref{fig:fov}). 
%CS: if it is not too complicated, I think it would help to add the names of 
%the galaxies into the plots and for the right panel, it makes sense to also add 
%NGC1379 and NGC1381, without sending the reader back to Fig.1
